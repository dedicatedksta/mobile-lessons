...
import ru.mirea.lybimovaa.osmmaps.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Мирэа, Стромынка", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker1.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Мирэа, Фрунзенская", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Мирэа, Вернадка", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Мирэа, Вернадка 2", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
